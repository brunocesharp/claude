...
metadata:
  ...
  output: docs/{projeto}/escopo/{titulo}/escopo.md
...
Leia todos os arquivos em `docs/{nome-do-projeto}/discovery/`:
...
Leia todos os `escopo.md` em `docs/{nome-do-projeto}/escopo/*/`:
...
Crie:
```
docs/{nome-do-projeto}/escopo/{titulo-kebab}/
├── escopo.md
└── discovery/
